...
(Pathway Analysis with Down-weighting of Overlapping Genes), but on top of the 
results of a Differential Translational Analysis (executed with DeltaTE).
...
It is from this idea that ***terapadog*** was conceived: to be able to perform a
gene set analysis (applying the same logic as used in the PADOG package, see 
references for additional info) on the sets highlighted as being actively under 
